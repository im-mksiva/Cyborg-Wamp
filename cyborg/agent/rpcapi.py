...
class AgentAPI(object):
    ...
    def fpga_program_old(self, context, hostname, controlpath_id,
    ...
    def fpga_program(self, context):
        ...
        target = oslo_messaging.Target(exchange="cyborg",topic="test",version=version)
        # cctxt = self.client.prepare(version=version, topic="test")
        client = oslo_messaging.RPCClient(transport, target)
        LOG.info("chiamata rpc")
        return client.call(context, 'call_wamp')
