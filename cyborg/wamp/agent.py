...
from cyborg.iotronic_common import exception
from cyborg.iotronic_common.i18n import _
from cyborg.iotronic_common.i18n import _LI
from cyborg.iotronic_common.i18n import _LW
from cyborg.iotronic_db import api as dbapi
...
class WampManager(object):
    def __init__(self):
        ...
        async def onJoin(session, details):
            ...
            import cyborg.wamp.functions as fun
